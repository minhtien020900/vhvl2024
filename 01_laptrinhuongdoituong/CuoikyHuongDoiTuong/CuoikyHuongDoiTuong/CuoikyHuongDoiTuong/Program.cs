    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!isLogin)
            {
                Console.Clear();
                Console.WriteLine("==============================================================================");
                Console.WriteLine("         Vui long chọn một người dùng theo danh sách phía dưới");
                Console.WriteLine("==============================================================================");
                DanhSachNguoiDung();
                ...
                switch (userChoice)
                {
                    case "1":
                        isLogin = true;
                        userID = 1;
                        tenNguoiDung = TenNguoiDung(1);
                        break;
                    case "2":
                        isLogin = true;
                        userID = 2;
                        tenNguoiDung = TenNguoiDung(2);
                        break;
                    case "3":
                        isLogin = true;
                        userID = 3;
                        tenNguoiDung = TenNguoiDung(3);
                        break;
                    default:
                ...
                if (isLogin)
                {
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        Thread.Sleep(500);  // Tạm dừng 500ms giữa mỗi dấu chấm
                    }
                }
            }
            ...
            while (isRunning)
            {
                ...
                Console.WriteLine("2. Danh sách theo tháng của người dùng");
                Console.WriteLine("3. Danh sách Thu Chi của người dùng trong tháng");
                Console.WriteLine("4. Tổng hợp Thu Chi Của người dùng trong tháng");
        ...
        {
            var lisNguoiDung = _db.nguoiDungs.Select(x => new
            {
                ID = x.NguoidungId,
                HoVaTen = x.Ten,
            }).ToList();
            ...
            {
                Console.WriteLine($"ID: {item.ID} - Họ Tên: {item.HoVaTen}");
            }
        ...
        {
            /*DanhSachNguoiDung();
            Console.Write("Vui lòng chọn một ID của người dùng theo danh sách trên và ấn enter:");
        ...
        {
            Console.WriteLine("Nhập ngày (theo định dạng MM/dd/yyyy ví dụ: 12/25/2024):");
            string date1 = Console.ReadLine();
            DateTime startDate = DateTime.Parse(date1);
            string date2 = Console.ReadLine();
            DateTime endDate = DateTime.Parse(date2);
